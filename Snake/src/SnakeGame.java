...
//			}
		...
		g.drawString("Score: "+applesEaten, (SCREEN_WIDTH - metrics1.stringWidth("Score: "+applesEaten))/2, g.getFont().getSize()+200);
		//g.drawString("High Score: "+high_score, (SCREEN_WIDTH - metrics1.stringWidth("High Score: "+high_score))/2, g.getFont().getSize());
		//Game Over text
		g.setColor(Color.red);
